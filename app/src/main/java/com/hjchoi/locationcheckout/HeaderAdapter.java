...
public class HeaderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private static final String LOG_TAG = HeaderAdapter.class.getSimpleName();
    ...
    // TODO: let's understand what WeakReference is
    ...
    public HeaderAdapter(Context ctx, ArrayList<String> data, ItemClickListener listener) {
        ...
        mData = data;
        mCallbackRef = new WeakReference<ItemClickListener>(listener);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            Log.d(LOG_TAG, "RecyclerView: onCreateViewHolder - type is item");
            View v = mLayoutInflater.inflate(R.layout.simple_list_item, parent, false);
            return new MyItem(v);
        } else if (viewType == TYPE_HEADER) {
            Log.d(LOG_TAG, "RecyclerView: onCreateViewHolder - type is header");
            View v = mLayoutInflater.inflate(R.layout.transparent_header_view, parent, false);
            return new HeaderItem(v);
        }
        Log.d(LOG_TAG, "RecyclerView: onCreateViewHolder - type is something else");
        return null;
    }
